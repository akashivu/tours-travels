...
export default function AdminDashboard() {
  ...
  <th className="border px-4 py-2 text-black">Trip Type</th>
  ...
  <th className="border px-4 py-2 text-black">Vehicle</th>
  ...
  <th className="border px-4 py-2 text-black">Actions</th>
      ...
      <td className="border px-4 py-2 text-center">{b.tripType}</td>
      <td className="border px-4 py-2 text-center">{b.pickupDate}</td>
      <td className="border px-4 py-2 text-center">{b.pickupTime}</td>
      <td className="border px-4 py-2 text-center">{b.mobile}</td>
      <td className="border px-4 py-2 text-center">{b.vehicleName}</td>
